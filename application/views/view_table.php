...
<table id="sample-table-2" class="table table-striped table-bordered table-hover">
    ...
    <tbody>
        ...
        <tr>
                ...
                <!-- <td><?php echo $no++; ?></td> -->
                <td><?php echo $row->id_lagu; ?></td>
                <td><?php echo $row->penyanyi; ?></td>
                <td><?php echo $row->judul; ?></td>
                <td><?php echo $row->genre; ?></td>
                <td>
                    <a href="<?php echo base_url()?>index.php/table/edit/<?php echo $row->id_lagu; ?>">edit</a>
                    <a href="<?php echo base_url()?>index.php/table/delete/<?php echo $row->id_lagu; ?>" onclick="return confirm('anda yakin ingin menghapus data ini?');  ">delete</a>
